...
const rendered = await renderSsr(resolve("dist/static/index.html"), entry.default); 
console.log(`prerendered: / ${(new TextEncoder().encode(rendered).byteLength / 1024).toFixed(2)}kb`);
